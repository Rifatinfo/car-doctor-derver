/*-------------------------------------------------------------------*/
/* Project: Activism Buddies - Social Campaign & Activism HTML5 Template */
/* Ver: 1.0.1*/
...
jQuery(function ($) {
  ...
  if ($("#countdown_block").length > 0) {
    let countDownDate = "2025/10/10"

    if ($("#countdown_block").data("date")) {
      countDownDate = $("#countdown_block").data("date")
    }

    $("#countdown_block").countdown(countDownDate, function (event) {
      var $this = $(this).html(event.strftime("" + '<div class="countdown_container"><h2 class="count_number">%D</h2><span class="count_text">Days</span></div>' + '<div class="countdown_container"><h2 class="count_number">%H</h2><span class="count_text">Hours</span></div>' + '<div class="countdown_container"><h2 class="count_number">%M</h2><span class="count_text">Miniutes</span></div>' + '<div class="countdown_container"><h2 class="count_number">%S</h2><span class="count_text">Seconds</span></div>'))
    })
  }
